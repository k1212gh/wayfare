"""Graph-transformation helpers used by run_stage6.

Extracted from stage6_screenmap/__init__.py (refactor Step 4). Each function
mutates the `graph` dict in place. __init__.py keeps run_stage6's
orchestration wireframe and re-imports these from here.
"""
